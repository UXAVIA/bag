class AppConstants {
  // Build flavor — injected at build time via --dart-define=FLAVOR=direct|playstore.
  // direct: all non-Play channels (website APK, F-Droid, sideload) — OpenNode/Ed25519 unlock.
  // playstore: Google Play only — in_app_purchase replaces the token path.
  static const kFlavor =
      String.fromEnvironment('FLAVOR', defaultValue: 'direct');

  // Google Play product ID for the Pro one-time purchase (playstore flavor only).
