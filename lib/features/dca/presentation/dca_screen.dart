...
class _StatsCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final priceFormatter = currencyFormatter(currency);
...
class _EntryTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final formatter = currencyFormatter(entry.currency);
    final cs = Theme.of(context).colorScheme;
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: GestureDetector(
                    onTap: () {
                      // iOS keeps the existing keyboard open when keyboardType
                      // changes on a focused field. Cycle focus to force a reload.
