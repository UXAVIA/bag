...
android {
    ...
    defaultConfig {
        ...
        minSdk = 24
        // Pinned rather than read from flutter.targetSdkVersion so the value
        // never depends on whichever Flutter SDK the build machine resolves.
        // Play requires target API within 1 year of the latest release.
        targetSdk = 36
